//package Dequeue;
//
//import Lists.CSLList;
//
//public class DoubleEndedQueue<T> implements Deque<T> {
//    /**
...
//        else return list.getFirst().getElement();
//    }
//
//    /**
...
//        if (isEmpty()) throw new EmptyDequeException();
//        else return list.getLast().getElement();
//    }
//
//    /**
...
//        if (element != null) list.addLast(element);
//    }
//
//    /**
...
//        if (isEmpty()) throw new EmptyDequeException();
////        else return list.remove(list.getFirst());
//    }
//
//    /**
...
//        if (isEmpty()) throw new EmptyDequeException();
////        else return list.remove(list.getLast());
//    }
//}
//
///**
...
//class EmptyDequeException extends Throwable { }
//
